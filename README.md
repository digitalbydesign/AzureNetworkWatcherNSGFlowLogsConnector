...
[![Deploy to Azure](http://azuredeploy.net/deploybutton.png)](https://github.com/digitalbydesign/AzureNetworkWatcherNSGFlowLogsConnector/blob/feature/campus/azureDeploy.json)
